      ...
      <section className="render-gallery" aria-labelledby="render-title">
        ...
        <div className="gallery-grid">
          <figure className="gallery-main">
            <Image src="/renders/kitchen-island.png" width={1448} height={1086} alt="客厅望向开放式厨房与独立中岛" priority unoptimized />
            <figcaption><span>01</span><strong>厨房与独立中岛</strong><em>海洋板 · 304 拉丝不锈钢</em></figcaption>
          </figure>
          <figure>
            <Image src="/renders/kitchen-detail.png" width={1448} height={1086} alt="海洋板柜体与不锈钢台面的厨房细节" unoptimized />
            <figcaption><span>02</span><strong>厨房材料细节</strong><em>电磁灶 · 北窗洗涤</em></figcaption>
          </figure>
          <figure>
            <Image src="/renders/living-storage.png" width={1448} height={1086} alt="客厅通顶储物墙与中岛连接关系" unoptimized />
